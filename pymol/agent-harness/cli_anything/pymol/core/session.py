"""PyMOL CLI - Session management with undo/redo."""
...
class Session:
    ...
    def get_project(self) -> Dict[str, Any]:
        if self.project is None:
            raise RuntimeError("No session loaded. Use 'project new' or 'project open' first.")
        return self.project
    ...
    def status(self) -> Dict[str, Any]:
        return {
            ...
            "session_name": self.project.get("name", "untitled") if self.project else None,
        }
