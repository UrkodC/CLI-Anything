...
try:
    from cli_anything.fiji.skills.mt_clip170.driver import cli as _mt_clip170_cli
    cli.add_command(_mt_clip170_cli)
except Exception as _e:  # pragma: no cover
    # pyyaml or other optional dep missing — skip registration silently.
    # Run `python -m cli_anything.fiji.skills.mt_clip170.driver` directly to see the error.
    pass
